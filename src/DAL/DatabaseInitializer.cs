    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("admin", "P@ss123", "Inbuilt Administrator", "admin@ebenmonney.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "P@ss123", "Inbuilt Standard User", "user@ebenmonney.com", "+1 (123) 000-0001", new string[] { userRoleName });
